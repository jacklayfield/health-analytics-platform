...
MLFLOW_TRACKING_URI = os.getenv(
    "MLFLOW_TRACKING_URI", ML_CONFIG.get("mlflow", {}).get("tracking_uri")
)
MODEL_REGISTRY = os.getenv(
    "MODEL_REGISTRY",
    ML_CONFIG.get("ml", {}).get("model_registry_name", "health_models"),
)

POSTGRES_URI = os.getenv(
    "POSTGRES_URI",
    ML_CONFIG.get("data", {}).get(
        "warehouse_uri", "postgresql://user:pass@localhost:5432/db"
    ),
)
