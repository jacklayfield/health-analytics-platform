...
parser.add_argument("-s", "--seed", type=int, help="Random seed (reproducible runs)")

parser.add_argument("-g", "--gender", choices=["M", "F"], help="Gender (M or F)")

parser.add_argument("-a", "--age", help="Age range (e.g. 18-65)")

parser.add_argument("-m", "--module", help="Path to a Synthea module JSON file")

parser.add_argument("--rebuild", action="store_true", help="Force rebuild of Synthea")

# Positional arguments: state and optional city
parser.add_argument(
    "state", nargs="?", help="US state (e.g. 'Massachusetts', 'California')"
)
...
OUTPUT_DIR = Path(os.environ.get("OUTPUT_DIR", SCRIPT_DIR / "../../../data")).resolve()
...
if not jar_path.exists():
    ...
    urllib.request.urlretrieve(
        "https://github.com/synthetichealth/synthea/releases/download/v3.1.0/"
