        ...
        [
                        ...
                        dbc.Card(
                            [
                                dbc.CardBody(
                                    [
                                        html.H6(
                                            "Total Records", className="card-title"
                                        ),
                        ...
                        dbc.Card(
                            [
                                dbc.CardBody(
                                    [
                                        html.H6(
                                            "Unique Categories", className="card-title"
                                        ),
                        ...
                        dbc.Card(
                            [
                                dbc.CardBody(
                                    [
                                        html.H6(
                                            "Latest Record Date", className="card-title"
                                        ),
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col([html.H5("Data Table"), html.Div(id="data-table")], md=4),
                ],
                className="mb-4",
            ),
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        [html.H5("Trend Over Time"), dcc.Graph(id="trend-chart")], md=6
                    ),
                ]
            ),
        ],
