...
def create_mock_data():
    ...
    data = {
        ...
        "reaction": np.random.choice(
            ["nausea", "headache", "rash", "fever", "dizziness"], n_samples
        ),
        "brand_name": np.random.choice(
            ["drug_a", "drug_b", "drug_c", "drug_d"], n_samples
        ),
        ...
        preprocessor = ColumnTransformer(
            [
                ...
                (
                    ...
                    ["patientsex", "reaction", "brand_name"],
                ),
            ]
        )
...
def test_model_evaluation():
    ...
    try:
        ...
        results = evaluator.evaluate_classification(
            model=model, X_test=X_test, y_test=y_test, model_name="test_model"
        )
