...
class TestDataLoader:
    ...
    def test_load_data_with_filters(self, mock_create_engine, mock_config, sample_data):
        ...
        with patch("pandas.read_sql", return_value=sample_data) as mock_read_sql:
            ...
            loader.load_data("openfda_events", filters=filters)
    ...
    def test_load_data_with_columns(self, mock_create_engine, mock_config, sample_data):
        ...
        with patch("pandas.read_sql", return_value=sample_data) as mock_read_sql:
            ...
            loader.load_data("openfda_events", columns=columns)
    ...
    def test_load_data_with_limit(self, mock_create_engine, mock_config, sample_data):
        ...
        with patch("pandas.read_sql", return_value=sample_data) as mock_read_sql:
            loader = DataLoader(mock_config)
            loader.load_data("openfda_events", limit=100)
    ...
    def test_validate_data_quality_valid(
        self, mock_create_engine, mock_config, sample_data
    ):
    ...
    @patch("src.data.data_loader.create_engine")
    def test_validate_data_quality_insufficient_rows(
        ...
        small_data = pd.DataFrame({"serious": [1, 0]})
    ...
    @patch("src.data.data_loader.create_engine")
    def test_validate_data_quality_missing_target(
        self, mock_create_engine, mock_config, sample_data
    ):
    ...
    @patch("src.data.data_loader.create_engine")
    def test_validate_data_quality_high_missing_ratio(
        self, mock_create_engine, mock_config
    ):
        ...
        loader = DataLoader(mock_config)
        result = loader.validate_data_quality(
            data_with_missing, "serious", max_missing_ratio=0.5
        )
    ...
    def test_get_data_info(self, mock_create_engine, mock_config):
        ...
        # Mock sample data
        sample_data = pd.DataFrame({"patientonsetage": [25, 30], "serious": [1, 0]})
