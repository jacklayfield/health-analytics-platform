...
class TestModelEvaluator:
    ...
    def test_evaluate_classification_without_cv(
        self,
        mock_eval_config,
        mock_training_config,
        sample_classification_data,
    ...
    def test_evaluate_regression(
        self, mock_eval_config, mock_training_config, sample_regression_data
    ):
    ...
    def test_compare_models(self, mock_eval_config, mock_training_config):
        ...
        comparison_df = evaluator.compare_models(
            model_results, primary_metric="accuracy"
        )
    ...
    def test_generate_evaluation_report(
        self, mock_eval_config, mock_training_config, tmp_path
    ):
    ...
    def test_plot_evaluation_metrics(
        self, mock_eval_config, mock_training_config, tmp_path
    ):
    ...
    def test_calculate_classification_metrics_with_probabilities(
        self, mock_eval_config, mock_training_config
    ):
