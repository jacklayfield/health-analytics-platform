...
class ModelEvaluator:
    ...
    def evaluate_classification(
        ...
        if X_train is not None and y_train is not None:
            cv_scores = self._cross_validate_classification(model, X_train, y_train)
    ...
    def evaluate_regression(
        ...
        cv_scores = None
        if X_train is not None and y_train is not None:
            cv_scores = self._cross_validate_regression(model, X_train, y_train)
            metrics.update(cv_scores)
    ...
    def compare_models(
        self, model_results: List[Dict[str, Any]], primary_metric: str = "accuracy"
    ) -> pd.DataFrame:
        """
        ...
        logger.info(
            f"Model comparison completed. Best model by {primary_metric}: "
    ...
    def generate_evaluation_report(
        self, evaluation_results: Dict[str, Any], output_dir: str = "artifacts"
    ) -> str:
        """
